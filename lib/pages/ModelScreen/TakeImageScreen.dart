...
import 'package:skidoo_app/pages/ModelScreen/ImageCropper.dart';
...
class TakePictureScreenState extends State<TakeImageScreen> {
            ...
            await _controller.startImageStream((image) async {
              ...
              if (faces.isNotEmpty) {
                ...
                Navigator.of(context).push(MaterialPageRoute(
                  builder: (context) =>
                      CropperScreen(file: file.readAsBytesSync()),
                ));
              } else {
                showDialog(
                    context: context,
